...
// let setTokenTimestamp;
// let setLocalAccessToken; 
// let setLocalRefreshToken;
// let getTokenTimestamp;
// let getLocalAccessToken;
// let getLocalRefreshToken;

// if (typeof window !== 'undefined') {
//   setTokenTimestamp = () => window.localStorage.setItem('spotify_token_timestamp', Date.now());
//   setLocalAccessToken = token => {
//     setTokenTimestamp();
//     window.localStorage.setItem('spotify_access_token', token);
//   };
//   setLocalRefreshToken = token => window.localStorage.setItem('spotify_refresh_token', token);
