...
- **[How Portable Is Spotify?](draft.md): Exporting My Saved Music**
  ...
  > I was disappointed to discover, when I tried to migrate my playlists to Tidal, that the free versions of both recommended transfer apps have 250-song restrictions–and the paid versions are subscription apps. I would rather not enroll in a monthly subscription to what would likely be a single-use app.
